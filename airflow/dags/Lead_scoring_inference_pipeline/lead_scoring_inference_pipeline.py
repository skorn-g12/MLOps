...
# ##############################################################################
genModelsPredictionTask = PythonOperator(task_id="generating_models_prediction",
...
# ##############################################################################
checkModelPredictionRatioTask = PythonOperator(task_id="checking_model_prediction_ratio",
...
# ##############################################################################
checkInputFeaturesTask = PythonOperator(task_id="checking_input_features",
...
# ##############################################################################
encodeFeaturesTask >> checkInputFeaturesTask >> genModelsPredictionTask >> checkModelPredictionRatioTask
